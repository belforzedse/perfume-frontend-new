  ...
  return (
    <section className="flex flex-col gap-6 sm:gap-8 md:gap-10" dir="rtl">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
        <div className="rounded-xl border border-[var(--color-border)] bg-gradient-to-br from-purple-50 to-white p-5 shadow-sm">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-gradient-to-br from-blue-50 to-white p-5 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-gradient-to-br from-green-50 to-white p-5 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
      ...
      {/* Guide Section */}
      <div className="rounded-xl sm:rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-gradient-to-br from-amber-50/50 to-white p-5 md:p-6">
